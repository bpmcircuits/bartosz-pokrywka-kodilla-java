...
//        long sumOfElapsedTime = project.getTaskLists().stream()
...
//                .sum();
//
//        double averageOfElapsedTime = numberOfTasksInProgress != 0 ?
//                (double) sumOfElapsedTime / numberOfTasksInProgress :
//                0;

        double averageOfElapsedTime = project.getTaskLists().stream()
        ...
        //Then
        assertEquals(10, averageOfElapsedTime);
